...
- Discovered Go tests/fuzz targets: **890**
- Reused now: **41**
- New local/contract tests required: **44**
- Live/provider/system tests required: **72**
- Unmapped: **0**
...
| `C11` | NEW | rating | `test/pivot/commerce_v2_test.go::TestUsage_ApifyAndBrightDataMetersRemainProviderSpecificButInvoiceStable` |
